package com.alexbchr.testutilities.internal.util;
...
public class TestUtilitiesStatus implements IStatus {
	 ...
	 * WARNING and INFO.
	 */
	public TestUtilitiesStatus(int severity, String message) {
		fStatusMessage= message;
		fSeverity= severity;
	}

	public static IStatus createError(String message) {
		return new TestUtilitiesStatus(IStatus.ERROR, message);
	}

	public static IStatus createWarning(String message) {
		return new TestUtilitiesStatus(IStatus.WARNING, message);
	}

	public static IStatus createInfo(String message) {
		return new TestUtilitiesStatus(IStatus.INFO, message);
	}
	...
	public String getPlugin() {
		return TestUtilitiesPlugin.PLUGIN_ID;
	}
