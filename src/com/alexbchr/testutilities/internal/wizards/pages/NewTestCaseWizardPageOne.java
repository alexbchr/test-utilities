...
import com.alexbchr.testutilities.internal.util.LayoutUtil;
import com.alexbchr.testutilities.internal.util.TestUtilitiesStatus;
import com.alexbchr.testutilities.internal.wizards.MethodStubsSelectionButtonGroup;
import com.alexbchr.testutilities.internal.wizards.WizardMessages;
import com.alexbchr.testutilities.priorj.core.JUnitLaunch.JUnitPlugin;
...
public class NewTestCaseWizardPageOne extends NewTypeWizardPage {
	...
	public NewTestCaseWizardPageOne(NewTestCaseWizardPageTwo page2) {
		...
		fClassUnderTestStatus= new TestUtilitiesStatus();

		fClassUnderTestText= ""; //$NON-NLS-1$

		fJunit4Status= new TestUtilitiesStatus();
		fIsJunit4= false;
	}
	...
	private IStatus junit4Changed() {
		TestUtilitiesStatus status= new TestUtilitiesStatus();
		return status;
	}
	...
	private boolean isDefaultSuperClass() {
		return getSuperClass().equals("java.lang.Object"); //$NON-NLS-1$
	}
